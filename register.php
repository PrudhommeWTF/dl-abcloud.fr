    ...
    case 'validation':
        ...
        if($pwdValidator == 'ok' && $mailValidator == 'ok'){
            ...
            <form class="form-signin" method="POST" action="?step=validation">
                ...
                <input type="text" class="form-control <?php if($mailValidator == 'nok'){ echo 'alert-danger'; } ?>" id="mailAddress" name="data[mailAddress]" value="<?php echo $mail; ?>" <?php if($mailValidator == 'nok'){ echo 'autofocus'; } ?>>
                <input type="password" class="form-control <?php if($pwdValidator == 'nok1'){ echo 'alert-danger'; } ?>" id="pwd" name="data[pwd]" value="<?php echo $pwd; ?>" <?php if($pwdValidator == 'nok1' || $pwdValidator == 'nok2'){ echo 'autofocus'; } ?>>
                <input type="password" class="form-control <?php if($pwdValidator == 'nok2'){ echo 'alert-danger'; } ?>" id="pwdConf" name="data[pwdConf]" placeholder="Confirmation de votre mot de passe.">
    ...
    default:
        ?>
            <form class="form-signin" method="POST" action="?step=validation">
                ...
                <input type="text" class="form-control" id="mailAddress" name="data[mailAddress]" placeholder="Votre adresse mail." autofocus>
                <input type="password" class="form-control" id="pwd" name="data[pwd]" placeholder="Votre mot de passe.">
                <input type="password" class="form-control" id="pwdConf" name="data[pwdConf]" placeholder="Confirmation de votre mot de passe.">
                <button class="btn btn-large btn-primary btn-block" type="submit">S'enregistrer</button>
            </form>
        <?php
        break;
