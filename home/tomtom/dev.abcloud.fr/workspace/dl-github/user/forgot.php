...
switch($case){
    case 'pwdReset':
        ...
        $userUID = $queryVerifMail->fetch(PDO::FETCH_OBJ);
        ...
        <?php
            ...
            $uid = md5(time()).$verifMail->userUID;
                ...
                if(isset($_GET['UID'])){
                    ...
                    if($newPwd['pwd']==$newPwd['pwdConf']){
                        if(pwdValidator($newPwd['pwd'])){
                            ...
                            $eraseResetUID = $bdd->exec("UPDATE dl_users SET userPwdResetUID = NULL WHERE userPwdResetUID = '".$_GET['UID']."'") or die (print_r($bdd->errorInfo()));
                            ?>
                            <div class="alert alert-success text-center">
