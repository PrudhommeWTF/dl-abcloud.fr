...
<head>
    ...
    <?php
    } elseif ($_SERVER['PHP_SELF'] == '/register.php' || $_SERVER['PHP_SELF'] == '/user/forget.php' || $_SERVER['PHP_SELF'] == '/login.php'){
        ?>
...
<div class="navbar navbar-fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php if(isset($_COOKIE['sessionStat']) && $_COOKIE['sessionStat'] == md5('logged')){ echo '/home.php'; } else { echo '/'; } ?>"><?php echo $appName; ?></a>
        <div class="nav-collapse collapse">
            ...
            if($_SERVER['PHP_SELF'] == '/index.php'){
                ...
                <ul class="nav navbar-nav">
                    <li><a href="<?php if(isset($_COOKIE['sessionStat']) && $_COOKIE['sessionStat'] == md5('logged')){ echo 'home.php'; } else { echo '#'; }?>">Accueil</a></li>
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    if(!isset($_COOKIE['sessionName'])){
                        ...
                        ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Bienvenue, <?php if(!empty($data->userFName)){ echo urldecode($data->userFName); } else { echo $data->userMail; } ?> <b class="caret"></b></a>
            ...
            <?php
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li <?php if($_SERVER['PHP_SELF'] == '/upload.php'){ echo 'class="active"'; }?>><a href="/upload.php">Envoyer des fichiers</a></li>
                </ul>
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Bienvenue, <?php if(!empty($data->userFName)){ echo urldecode($data->userFName); } else { echo $data->userMail; } ?> <b class="caret"></b></a>
