            ...
            if(md5($dataForm['mail']) !== $data->userMail){
                ...
                <?php
                    ...
                    <div class="alert alert-success text-center">
                        <strong>Bravo !</strong> <p>Les changements d'informations on été opérer avec succès.</p>
                        <a class="btn btn-success" href="<?php echo $_SERVER['HTTP_REFERER']; ?>">Retour à la gestion de profil</a>
                    </div>
                <?php
                }
            }
        ...
        ?>
            <div class="well">
                ...
                <ul class="nav nav-pills" id="myTab">
                    <li class="profilPills active"><a href="#home" data-toggle="pill">Vos coordonnées</a></li>
                    <li class="profilPills"><a href="#offre" data-toggle="pill">Votre offre</a></li>
                    <li class="profilPills"><a href="#password" data-toggle="pill">Votre mot de passe</a></li>
                </ul>
                            ...
                            <div class="col-offset-1 col-lg-7">
                                <form action="?case=ch_coord" method="POST">
                                    <div class="input-group profilForm">
                                        ...
                                        <input type="text" class="form-control input-lg" name="dataForm[fname]" value="<?php echo urldecode($data->userFName); ?>">
                                    </div>
                                    <div class="input-group profilForm">
                                        <span class="input-group-addon input-lg">Nom</span>
                                        <input type="text" class="form-control input-lg" name="dataForm[sname]" value="<?php echo urldecode($data->userSName); ?>">
                                    </div>
                                    <div class="input-group profilForm">
                                        <span class="input-group-addon input-lg">Adresse mail</span>
                                        <input type="text" class="form-control input-lg" name="dataForm[mail]" value="<?php echo $data->userMail; ?>">
                                    </div>
                            ...
                            <div class="col-offset-1 col-lg-7">
                                ...
                                <form action="?case=ch_pwd" method="POST">
                                    <div class="input-group profilForm">
                                        ...
                                        <input type="password" class="form-control input-lg" name="dataPwd[pwd]" placeholder="Nouveau mot de passe">
                                    </div>
                                    <div class="input-group profilForm">
                                        <span class="input-group-addon input-lg">Confirmation du nouveau mot de passe</span>
                                        <input type="password" class="form-control input-lg" name="dataPwd[pwdConf]" placeholder="Confirmation du mot de passe" ">
                                    </div>
                                    <div class="text-center" style="padding-top: 10px;">
